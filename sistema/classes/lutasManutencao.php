...
*********************************************************************************/
	public function geraListaLutas(){
		...
		while($prod = self::results()){
			...
			echo '<tr>
      <td bgcolor="'.$corfnd.'" align="center"><img src="'.urlSite.'fotos/t_'.$prod["foto"].'" width="80" class="imgExibe" /></td>
      <td bgcolor="'.$corfnd.'" align="center">'.utf8_encode($prod['lutas']).'</td>
      <td bgcolor="'.$corfnd.'" align="center"><a href="'.urlPrincipal.'formAltLutas/'.$prod['id'].'"><img src="'.urlPrincipal.'imagens/alterar.png" width="80" height="24" border="0" /></a><a href="javascript:void();" class="excluir" id="'.$prod['id'].'"><img src="'.urlPrincipal.'imagens/excluir.png" width="80" height="24" border="0"/></a></td>
    </tr>			
				';
			$j++;
