...
class agendaManutencao extends criaPaginacao{
...
*********************************************************************************/
	public function geraLista(){
      ...
      <td bgcolor="'.$corfnd.'" align="center">'. $prod['evento'] .'</td>
	  <td bgcolor="'.$corfnd.'" align="center">'. exibeData($prod['data']) .'</td>
      <td bgcolor="'.$corfnd.'" align="center"><a href="formAltAgenda/'.$prod['id'].'"><img src="'.urlPrincipal.'imagens/alterar.png" width="80" height="24" border="0" /></a><a href="javascript:void();" class="excluir" id="'.$prod['id'].'"><img src="'.urlPrincipal.'imagens/excluir.png" width="80" height="24" border="0"/></a></td>
    </tr>			
				';
			$j++;
